# TWIX Explorer v1.0.0 🌐

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

TWIX Explorer is a read-only web application to browse the content of the blockchain. 
...
**Node.js 8, 9 or 10** is required to run TWIX Explorer as a web application.
