...
describe('Symbol Explorer Blocks detail page', () => {
    ...
    describe('Block Detail Card should', () => {
        ...
        it('render correct table fields.', () => {
            const items = ['Height', 'Size (bytes)', 'Date', 'Total Fee', 'Difficulty', 'Fee Multiplier', 'Collected Epoch Fees', 'Fee To Pay', 'Total Supply', 'Inflation', 'inflationMultiplier', 'Transactions', 'Harvester', 'Block Hash', 'Proof Gamma', 'Proof Scalar', 'Beneficiary Address', 'Proof Varification Hash']
