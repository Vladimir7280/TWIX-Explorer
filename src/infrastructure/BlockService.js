...
import { UInt64, TransactionGroup, Order, BlockOrderBy, BlockType } from 'twix-sdk';
...
class BlockService {
  ...
  static formatBlock = block => ({
	...
	collectedEpochFees: helper.toNetworkCurrency(block.collectedEpochFees),
	...
	inflationMultiplier: (block.inflationMultiplier.compact() / 100000).toString(),
